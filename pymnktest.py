...
def main():
    ...
    space.gravity = 0, 980
    static = [
        pymunk.Segment(space.static_body, (0, -50), (-50, sizey), 5),
        pymunk.Segment(space.static_body, (0, sizey), (sizex, sizey), 5),
        pymunk.Segment(space.static_body, (sizex, sizey), (sizex, -50), 5),
        pymunk.Segment(space.static_body, (-50, -50), (sizex, -50), 5),
    ]
    for s in static:
        s.collision_type = 1
    space.add(static)
